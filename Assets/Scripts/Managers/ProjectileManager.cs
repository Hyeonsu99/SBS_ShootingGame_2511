...
public class ProjectileManager : Singleton<ProjectileManager>
{
    ...
    protected override void DoAwake()
    {
        ...
        for(int i = 0; i < projectilePrefab.Length; ++i)
        {
            ...
            Allocate((Projectile.projectileType)i);
        }

    }

    private void Allocate(Projectile.projectileType type)
    {
        GameObject go;
    ...
    public void FireProjectile(Projectile.projectileType type,
                                Vector3 spawnPos,
                                Vector2 direction,
                                GameObject owner,
                                int damage,
    ...
    private Projectile GetProjectileFromPool(Projectile.projectileType type)
    {
    ...
    public void ReturnProjectileToPool(Projectile returnProj, Projectile.projectileType type)
    {
